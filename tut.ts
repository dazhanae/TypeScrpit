...
document.write("myname is a " + typeof(
  myName) + "<br />");
document.write("canVote is a " + typeof(
      myName) + "<br />");
  document.write("anything is a " + typeof(
        myName) + "<br />");
...
document.write("5 + String 2 = " + (5+ '2') + "<be />");
 var randomNum: number = 1;

 document.write("randNum++ =" + randomNum++ + "<br />");
 document.write("++randNum = " + ++randomNum + "<br />");
 document.write("randNum-- = " + randomNum-- + "<br />");
 document.write("--randNum = " + --randomNum + "<br />");
